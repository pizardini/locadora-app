...
@section('content')
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input id="name" type="text" name="name" class="form-control" placeholder="Nome" value="{{ $product->name }}">
        </div>
        <div class="form-group">
            <strong>Sinopse:</strong>
            <textarea id="overview" class="form-control" style="height:150px" name="detail" placeholder="Detalhes do filme">{{ $product->detail }}</textarea>
        </div>
    </div>
    <div class="col-md-6">
        <div id="movieCoverContainer" class="flex items-center p-4 ml-md-3">
            <input type="hidden" name="cover" id="coverInput">
            <img id="movieCoverImage" src="{{ $product->cover }}" alt="Capa do Filme" style="height:350px" class="rounded img-fluid">
        </div>
    </div>
</div>
